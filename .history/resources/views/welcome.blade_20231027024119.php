...
<html lang="en">
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:gap-5 lg:gap-6">
                        ...
                        <div class="card px-4 pb-4 sm:px-5">
                            ...
                            <div class="code-wrapper hidden pt-4">
                                ...
                                >
                                    <code class="language-cli" x-ignore>
    ...
    laravel new example-app
                    ...
                    <div class="grid grid-cols-1 gap-4 sm:gap-5 lg:gap-6">
                        ...
                        <div class="card px-4 pb-4 sm:px-5">
                            <div class="my-3 flex h-8 items-center justify-between">
                                <h2 class="font-medium tracking-wide text-slate-700 line-clamp-1 dark:text-navy-100 lg:text-base">
                                    Install Livewire if its not installed
                                </h2>
                                <label class="inline-flex items-center space-x-2">
                                    <span class="text-xs text-slate-400 dark:text-navy-300">Code</span>
                                    <input
    ...
    class SearchAccountNumber extends Component
    {
        ...
        public function selectAccountNumber($receiverId)
        {
            $receivingUser = User::where('id', $receiverId)-&gt;first();
            $this-&gt;receiverAccountNumber = $receivingUser;
            $this-&gt;reset('search');
        }
        // public function selec($accountNumber)
        // {
        //     $accountNumber = User::where('id', $accountNumber)-&gt;first();
        ...
        public function render()
        {
            ...
            if(strlen($this-&gt;search) &gt;= 1){
                $results = User::where('account_number', 'like', '%' . $this-&gt;search . '%')-&gt;get();
            }
